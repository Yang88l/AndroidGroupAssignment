...
public class lrt_ampang extends AppCompatActivity {
    ...
    public void pandan_indah(View view) {
        if (user_input.equals("from")) {
            from.setText("Pandan Indah");
            from_pos = 4;
        } else if (user_input.equals("to")) {
            to.setText("Pandan Indah");
            to_pos = 4;
        } else if (user_input.equals("")) {
            Toast.makeText(this, "Please press from or to before selecting station", Toast.LENGTH_SHORT).show();
        }
    ...
    public void pandan_jaya(View view) {
        if (user_input.equals("from")) {
            from.setText("Pandan Jaya");
            from_pos = 5;
        } else if (user_input.equals("to")) {
            to.setText("Pandan Jaya");
            to_pos = 5;
        } else if (user_input.equals("")) {
            Toast.makeText(this, "Please press from or to before selecting station", Toast.LENGTH_SHORT).show();
        }
    ...
    public void calculate() {
        ...
        go_cost = (station_travelled * 0.40) + station_travelled;
