...
public class mrt_putrajaya extends AppCompatActivity {
    ...
    public void home(View view) {
        Intent intent = new Intent(mrt_putrajaya.this, main.class);
        startActivity(intent);
    }
    public void heart(View view) {
        Intent intent = new Intent(mrt_putrajaya.this, my_favourite.class);
        startActivity(intent);
    }
    public void history(View view) {
        Intent intent = new Intent(mrt_putrajaya.this, book_history.class);
        startActivity(intent);
    }
    public void profile(View view) {
        Intent intent = new Intent(mrt_putrajaya.this, profile.class);
        startActivity(intent);
    }
}